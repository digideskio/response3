          ...
          <form name="partnerform">
            ...
            <div class="r3listing">
                <div class="filter">
                    ...
                    var v = '{"id":${instance.id}, "url":"${createLink(action:"filterCustomers")}", '+
                            '"link":"${createLink(controller:"customer", action:"show")}", "tbody":"customers-tbody"}';
	                ...
	                <tr>
	                    <td>
	                       ...
	                       <g:if test="${total > grailsApplication.config.response3.lists.length}">
                               <input data-order="${params.order}" type="submit" id="button" class="button more" value="${message(code:'show.more')}" onclick="r3execute(this);return false;"/>
                           </g:if>
	                    </td>
	                    <td>
	                       <g:if test="${total > grailsApplication.config.response3.lists.length}">
